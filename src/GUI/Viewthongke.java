...
public class Viewthongke extends JFrame {
    ...
    public JPanel View() {
        ...
        JPanel tk1 = new cardborder(Color.BLACK, Color.white, "src\\icon\\ccc.png", "Doanh số hôm nay", "1.400.000$",
                "increase 125%").View();
        header.add(tk1);

        JPanel tk2 = new cardborder(Color.BLACK, Color.white, "src\\icon\\ccc.png", "Doanh số hôm nay", "1.400.000$",
                "increase 125%").View();
        header.add(tk2);

        JPanel tk3 = new cardborder(Color.BLACK, Color.white, "src\\icon\\ccc.png", "Doanh số hôm nay", "1.400.000$",
                "increase 125%").View();
        header.add(tk3);
