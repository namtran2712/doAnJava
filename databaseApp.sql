...
CREATE TABLE ACCOUNTS (
  ...
  -- 0: Khóa tài khoản, 1: tài khoản hợp lệ, 2: tài khoản đã bị xóa
...
ADD FOREIGN KEY (ID_STAFF) REFERENCES STAFF (ID_STAFF) ON DELETE
SET 1;
...
DELIMITER $$
CREATE TRIGGER insertReceipt
AFTER INSERT ON PARTICULAR_RECEIPTS
FOR EACH ROW
BEGIN

  UPDATE PARTICULAR_PRODUCTS SET QUANTITY_REMAIN = QUANTITY_REMAIN + NEW.QUANTITY
